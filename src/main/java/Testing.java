import Models.DOB;
import Models.AthleteModels.Athlete;
import Models.AthleteModels.AthleteMethods;
        ...
        do{
            ...
            switch (choice) {
                case 1:
                    ...
                    AthleteMethods.addAthlete(new Athlete(surname, givenname, team, new DOB(month, day, year)));
                ...
                case 2:
                    ...
                    AthleteMethods.removeAthlete(removeId);
                ...
                case 3:
                    ...
                    Athlete foundAthlete = AthleteMethods.searchID(findId);
